                                ...
                                <div class="tab-content border border-top-0 p-3" id="languageTabsContent">
                                    ...
                                    <div class="tab-pane fade show active" id="english" role="tabpanel">
                                        <div class="row">
                                            ...
                                            echo $form->input('title[en]', __("title") . ' (' . __("english") . ')', old('title.en', $project['title_en'] ?? ''))
                                                ->attrs(['placeholder' => __("enter_project_title_en")])
                                                ->errorMessage(errors('title.en'))
                                                ->formGroupClass('col-md-6 mb-3')
                                                ->render();

                                            echo $form->textarea('description[en]', __("description") . ' (' . __("english") . ')')
                                                ->value(old('description.en', $project['description_en'] ?? ''))
                                    ...
                                    <div class="tab-pane fade" id="arabic" role="tabpanel">
                                        <div class="row">
                                            <?php
                                            echo $form->input('title[ar]', __("title") . ' (' . __("arabic") . ')', old('title.ar', $project['title_ar'] ?? ''))
                                            ...
                                            echo $form->textarea('description[ar]', __("description") . ' (' . __("arabic") . ')')
                                                ->value(old('description.ar', $project['description_ar'] ?? ''))
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    echo $form->input('technologies', __("technologies_used"))
                                        ...
                                        ->attrs(['placeholder' => __("tech_placeholder"), 'required' => true])
                                        ->formGroupClass('col-md-6 mb-3')
                                        ->class('form-control')
                                        ->render();
                                    ?>
