...
<!--<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">-->
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3">
        ...
        <a href="/admin/skills/add" class="btn btn-primary">
            ...
            { data: 'category' },
            {
                ...
                render: function (data) {
                    ...
                    <form id="delete-form-${data}" method="POST" action="/admin/skills/${data}/delete" style="display:inline;">
                        ...
                        <?= setCsrf() ?>
                        <button type="button" onclick="utils.confirmDelete('<?=getCsrf()?>','/admin/skills/${data}/delete')" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>
                    </form>
                `;
                }
            }
